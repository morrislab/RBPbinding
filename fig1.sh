...
### General data manipulation for Figure1 
...
python Scripts/pearson_vs_id.py 1 ${outdir}${zscores%.txt}_pearson.mat Rncmpt.aaseq.ext15_combined_lnormalignment_alignlocal_id.txt --protlist ${indir}${rrmkhlist} --boxplot --ylabel 'Pearson' --selfcorr Fullset_z_scores-setA-vs-setB-comparison.txt 1 --setylim 0 1
