...
python Scripts/motifset_cluster_4.py --plotfeatures ${outdir}JPLE_RRMKHcomplete/jplesvd122_nonorm_svdsignificant_response122.0_maplsq_-testset_Platent.npz 1 umap 2 --reduceparams 14,cosine,0.7,1.,42 --color_factorplot 30 None False True $proteinnames --savefig ${supfig}JPLElatent_umapeigenvectors.jpg
# Umap with location of Rnp4F, sart3, SART3
python Scripts/motifset_cluster_4.py --plotfeatures JPLE_RRMKHcomplete/jplesvd122_svdsignificant_response122.0_maplsq_decglobal_-testset_Platent.npz 1 umap 2 --reduceparams 14,cosine,0.7,1.,42 --clusterassignment centrecolor ${outdir}Zscores_420_origrncmpt_pearson_aggclusters-completegt0.6.npz --largecluster 5 --color_motifcomposition ${outdir}Zscores_420_origrncmpt_pwm.hmot pwm manual --annotate coloring outside 5 --motifshape ${indir}Rncmpt.aaseq_domainclass.txt --connect $seqid 40 --plotevo --savefig ${fig3}JPLElatent_with_sequenceidentity_motifcluster5.jpg --locate_protein $proteinnames RNCMPT00060,RNCMPT00064,RNCMPT00774
# Eigenvector distribution of entries and summary of content
python Scripts/Factor-visualization-beta.py $zscores ${outdir}Rncmpt.aaseq.ext15_domain_fused_5mer_features.npz $rrmkhlist 30 --normP2 --normY2 --makelist --bothends --zkmerchoice 10 6 5 --pkmerchoice 20 4 3 --infocont --removespines --plot_scoredistribution --savefig
