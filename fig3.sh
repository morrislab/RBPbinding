...
python Scripts/pylogo.py ${outdir}Zscores_420_origrncmpt_pearson_aggclusters-completegt0.6-motifsetvisual-minsize5-pwms.txt --infocont --removeaxis --transparent
...
python Scripts/Factor-visualization-beta.py ${indir}${zscores} ${outdir}Rncmpt.aaseq.ext15_domain_fused_5mer_features.npz ${indir}${rrmkhlist} 30 --normP2 --normY2 --makelist --bothends --zkmerchoice 10 6 5 --pkmerchoice 20 4 3 --infocont --removespines --plot_scoredistribution --savefig --outdir ${supfig}
