...
mkdir Performance/JPLEunknown
mkdir Performance/LRunknown
...
python Scripts/Specificity_predictors.py ${indir}${zscores} ${outdir}Rncmpt.aaseq.ext15_domain_fused_5pm1_5mer_features.npz --trainingset $i ${outdir}${rrmkhlist%.list}-Zscores_420_origrncmpt_pearson0.6_testsetSingle.list --JPLE svd 122 significant_response lsq local --savetestcorrelation --savetopintersection --savetopcorrelation --savetestprofileslight --savelatentstats --determine_sequence Dummy_RRMKH_49species_5pm1_features.npz --normP2 --normY2 --outname ${perform}JPLEunknown/jplesvd122_set${i}
# Run OLS for all leave-one out sets
python Scripts/Specificity_predictors.py ${indir}${zscores} ${outdir}Rncmpt.aaseq.ext15_domain_fused_5pm1_5mer_features.npz --trainingset $i ${outdir}${rrmkhlist%.list}-Zscores_420_origrncmpt_pearson0.6_testsetSingle.list --LinearRegression 0 False False --savetestcorrelation --savetopintersection --savetopcorrelation --savetestprofileslight --determine_sequence Dummy_RRMKH_49species_5pm1_features.npz --normP2 --normY2 --outname ${perform}LRunknown/lr_set${i}
done
